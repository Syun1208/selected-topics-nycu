"""Adapted from https://github.com/georg-bn/rotation-steerers
"""
import torch
...
from models.rotation_steerers.matchers.dual_softmax_matcher import DualSoftMaxMatcher
...
class MaxMatchesMatcher(nn.Module):
    ...
    def match(self, keypoints_A, descriptions_A, 
        ...
        best_num_matches = -1
        matches_A = matches_B = batch_inds = idxs = None
        best_power = 0
        ...
        if rot_est:
            ...
            return matches_A, matches_B, idxs
