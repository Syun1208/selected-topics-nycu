import torch
from ...modules.loss.solvers import weighted_procrustes
from ...modules.utils.training_utils import backproject_3d, soft_inlier_counting_3d, inlier_counting_3d
    ...
    def estimate_pose(self, batch, return_inliers=False):
        ...
        for i_i in range(self.it_matches):
            ...
            try:
                ...
                print(f'[Except Reached]: Invalid matching matrix! {e}')
                break
