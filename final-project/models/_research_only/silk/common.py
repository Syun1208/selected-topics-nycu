...
from models._research_only.silk.models.silk import matcher
...
def load_images(*paths, as_gray: bool = True, device: torch.device):
...
def get_model(
    ...
    default_outputs: Tuple[str, ...] = SILK_DEFAULT_OUTPUT,
):
