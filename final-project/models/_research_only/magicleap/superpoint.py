...
class SuperPoint(nn.Module):
    ...
    def __init__(self, config):
        ...
        if self.config.get("fix_sampling"):
            self.fix_sampling = True
            print("MagicLeap SuperPoint use sample_descriptors_fix_sampling()")
        else:
            self.fix_sampling = False
