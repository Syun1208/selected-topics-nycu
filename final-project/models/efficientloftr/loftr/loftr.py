...
from models.efficientloftr.loftr.backbone import build_backbone
from models.efficientloftr.loftr.loftr_module import LocalFeatureTransformer, FinePreprocess
from models.efficientloftr.loftr.utils.coarse_matching import CoarseMatching
from models.efficientloftr.loftr.utils.fine_matching import FineMatching


def detect_NaN(feat_0, feat_1):
    print(f'NaN detected in feature')
    print(f"#NaN in feat_0: {torch.isnan(feat_0).int().sum()}, #NaN in feat_1: {torch.isnan(feat_1).int().sum()}")
