# Adapted from https://github.com/vignywang/MTLDesc/blob/master/evaluation_hpatch/models/MTLDesc.py
...
class MTLDescExtractor(object):

    def __init__(self, device: Optional[torch.device] = None, **config):
        self.name = 'MTLDesc'
        self.config = {
