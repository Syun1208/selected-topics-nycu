"""Adapted from https://github.com/Shiaoming/ALIKED
"""
...
from models.aliked.nets.blocks import *
from models.aliked.nets.padder import InputPadder
from models.aliked.nets.soft_detect import DKD
...
class ALIKED(nn.Module):
    ...
    def __init__(
        ...
        # load pretrained
        if load_pretrained:
            pretrained_path = pretrained_path or osp.join(osp.split(__file__)[0], f'../models/{model_name}.pth')
