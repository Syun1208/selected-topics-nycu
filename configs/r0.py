...
# Empirical peak on val is at iter ~18144 (162 epochs); stop there to avoid overfit.
_max_iters = 162 * iters_per_epoch  # = 18144, multiple of val_interval (1008)
...
optim_wrapper = dict(
    type='OptimWrapper',
    constructor='MultiEMAOptimWrapperConstructor',
...
param_scheduler = [
    ...
    # cosine decay to 1% of base LR — prevents the long-tail overfit observed at
    # constant 5e-4 (val started dropping after iter ~18k with the old flat LR).
